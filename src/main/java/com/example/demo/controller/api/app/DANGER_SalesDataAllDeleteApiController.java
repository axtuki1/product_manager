...
@Controller
public class DANGER_SalesDataAllDeleteApiController {

	@Autowired
	SalesDataRepository repository;
	@Autowired
	ItemSalesRepository irepository;
	 ...
	 * @Method GET
	 */
	@RequestMapping(path = "/api/v1/DANGER/SalesDataAllClear", method = RequestMethod.POST)
